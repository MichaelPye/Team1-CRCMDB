...
namespace Team1_CRCMDB {
    ...
    public partial class MovieDBDataSet : global::System.Data.DataSet {
        ...
        public partial class MovieDataTable : global::System.Data.TypedTableBase<MovieRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MovieRow AddMovieRow(int MovieId, string Title, string Year, string Genre) {
...
namespace Team1_CRCMDB.MovieDBDataSetTableAdapters {
    ...
    public partial class MovieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Movie] WHERE (([MovieId] = @Original_MovieId) AND ((@IsNull_Ye" +
                "ar = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Genre = 1" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Movie] ([MovieId], [Title], [Year], [Genre]) VALUES (@MovieId," +
                " @Title, @Year, @Genre);\r\nSELECT MovieId, Title, Year, Genre FROM Movie WHERE (M" +
                "ovieId = @MovieId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Movie] SET [MovieId] = @MovieId, [Title] = @Title, [Year] = @Year, [Genre] = @Genre WHERE (([MovieId] = @Original_MovieId) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)));
SELECT MovieId, Title, Year, Genre FROM Movie WHERE (MovieId = @MovieId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Team1_CRCMDB.Properties.Settings.Default.MovieDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MovieId, Title, Year, Genre FROM dbo.Movie";
        ...
        public virtual int Delete(int Original_MovieId, string Original_Year, string Original_Genre) {
        ...
        public virtual int Insert(int MovieId, string Title, string Year, string Genre) {
        ...
        public virtual int Update(int MovieId, string Title, string Year, string Genre, int Original_MovieId, string Original_Year, string Original_Genre) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Year, string Genre, int Original_MovieId, string Original_Year, string Original_Genre) {
            return this.Update(Original_MovieId, Title, Year, Genre, Original_MovieId, Original_Year, Original_Genre);
        }
    }
